...
@section('content')
  ...
  <div class="blog-page">
          ...
          @while ($featured_query->have_posts())
            ...
            <article class="blog-featured">
              ...
              <div class="blog-featured__body">
                ...
                <p class="blog-featured__excerpt">{{ html_entity_decode(wp_trim_words(get_the_excerpt(), 38, '...'), ENT_QUOTES, 'UTF-8') }}</p>
    ...
    {{-- =================== NEWSLETTER =================== --}}
    <section class="blog-newsletter" aria-labelledby="blog-newsletter-title" data-cmplz-gate="statistics" style="display:none;">
      <div class="container">
