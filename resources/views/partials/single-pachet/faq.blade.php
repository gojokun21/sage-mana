{{-- Single PACHET — FAQ. ACF (grup pachet, seed `natura:pachet-seed`) cu fallback static.
     Accordion nativ <details> → animat de faq-accordion.js. --}}
@php
  $faqs = collect(get_field('pk_faq_items') ?: [])
