{{-- PDP — mini CTA quiz (static). --}}
<section class="quiz-mini">
  <div class="quiz-card">
    ...
    <h3>{{ __('Nu știi dacă acest produs', 'sage') }} <em>{{ __('e pentru tine', 'sage') }}</em>?</h3>
    <p>{{ __('Fă testul de 60 sec — îți spunem onest dacă merge sau dacă un pachet ar avea mai mult sens.', 'sage') }}</p>
