...
@if (! empty($top_categories ?? []))
  <section class="home-section home-categories" aria-labelledby="home-categories-title">
    ...
    <div class="home-slider">
      {{-- Viewport wraps the swiper + nav buttons so `top: 50%` on the
           buttons centers on the slide row only, excluding the pagination
           below. Pagination stays a direct child of .home-slider. --}}
