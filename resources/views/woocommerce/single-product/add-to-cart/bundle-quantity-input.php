...
if ( ! $product->is_sold_individually() ) {
	...
	$max_stock = ( ! $product->backorders_allowed() && $raw_stock !== null ) ? max( 0, (int) $raw_stock ) : '';

	echo '<div class="mn-qty-wrap">';
	woocommerce_quantity_input(
		array(
			...
			/** Core WC filter. */
			'max_value'   => apply_filters( 'woocommerce_quantity_input_max', $max_stock, $product ), // phpcs:ignore WooCommerce.Commenting.CommentHooks.MissingSinceComment
