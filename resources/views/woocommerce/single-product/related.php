...
// Keep only published, visible products — hides the whole section when none remain.
$related_products = is_array( $related_products )
	? array_filter( $related_products, function ( $p ) {
