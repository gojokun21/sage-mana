...
?>
<div class="cart" data-title="<?php echo esc_attr( $bundled_item->get_title() ); ?>"
	...
	data-type="<?php echo esc_attr( $bundled_item->get_product()->get_type() ); ?>"
	...
	data-product_id="<?php echo esc_attr( $bundled_item->get_product()->get_id() ); ?>"
	data-bundle_id="<?php echo esc_attr( $bundle->get_id() ); ?>">
	<div class="bundled_item_wrap">
		<div
			class="bundled_item_cart_content" <?php echo $bundled_item->is_optional() && ! $bundled_item->is_optional_checked() ? 'style="display:none"' : ''; ?>>
